...
export function Spotlight({
  ...
  return (
    <div className={cn("absolute inset-0 overflow-hidden", className)}>
      <div
        className="absolute -top-40 -right-40 h-96 w-96 opacity-30"
        style={{ background: gradientFirst }}
      />
      <div
        className="absolute -bottom-40 -left-40 h-96 w-96 opacity-20"
        style={{ background: gradientSecond }}
      />
      <div
        className="absolute top-1/2 left-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 opacity-10"
